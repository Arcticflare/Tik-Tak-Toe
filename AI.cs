...
namespace Tik_Tak_Toe
{
    public static class AI
    {
        ...
        public static void AiTurn(List<XO.Square> squareList)
        {
            ...
            if(TURN == 1)
            {
                //If player takes center square first.
            ...
            if(TURN == 2)
            {
                //This set is if player has center square, please refactor!!!!!!
                if (CENTER == true)
                {
                    ...
                    if(Squares[1] == XO.Square.O)
                    {
                        squareList[7] = XO.Square.X;
                    }

                    if(Squares[2] == XO.Square.O)
                    {
                        squareList[7] = XO.Square.X;
                    }
